...
import net.savagedev.tpa.velocity.command.TpaGuiCommand;
...
@Plugin(id = "velocitytp", name = "VelocityTP", version = "1.0.4",
...
public class BungeeTpVelocityPlugin implements BungeeTpPlatform {
    ...
    public void onProxyInitialization(ProxyInitializeEvent ignored) {
        ...
        final CommandMeta meta = commandManager.metaBuilder("tpagui")
                .aliases("tpg")
                .plugin(this)
                .build();
        commandManager.register(meta, new TpaGuiCommand(this));
