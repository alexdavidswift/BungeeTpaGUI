...
import net.savagedev.tpa.common.messaging.messages.*;
...
public abstract class BungeeTpBridgeMessenger<T> extends AbstractMessenger<T> {
    ...
    public void handleIncomingMessage(Message message) {
        ...
        if (message instanceof MessageOpenTeleportGui) {
            this.handleTeleportGuiRequest((MessageOpenTeleportGui) message);
            return;
        }
    ...
    protected void handleTeleportGuiRequest(MessageOpenTeleportGui request) {
        // Overridden by platforms that support this feature.
    }
